...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            <div class="page-header" id="bannerClose"><h3 class="page-title"><span class="page-title-icon bg-gradient-primary text-white mr-2"><i class="mdi mdi-pencil"></i></span>Payroll Form Update</h3></div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="month" class="form-control" id="month" name="month" value="{{$payroll->month}}">
                        </div>
                        <div class="form-group">
                            ...
                            <select class="form-control" name="department" id="department" >
                                ...
                                @foreach($departments as $department)
                                    <option value="{{$department->id}}" @if($department->id == $payroll->department_id) selected @endif>{{$department->department_name}}</option>
                                @endforeach
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="salary" name="salary" value="{{$payroll->salary}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="kpi" >KPI</label>
                            <input type="text" class="form-control" id="kpi" name="kpi" value="{{$payroll->kpi}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="leave" >Number of Leave in That Month</label>
                            <input type="text" class="form-control" id="leave" name="leave" value="{{$payroll->number_of_leaves}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="leave_deduction" >Leave Deduction Amount / Day</label>
                            <input type="text" class="form-control" id="leave_deduction" name="leave_deduction" value="{{$payroll->leave_deduction}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="late_attendance" >Late Attendance in that Month</label>
                            <input type="text" class="form-control" id="late_attendance" name="late_attendance" value="{{$payroll->late_attendance}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="late_attendance_fee" >Late Attendance Deduction Amount / Day</label>
                            <input type="text" class="form-control" id="late_attendance_fee" name="late_attendance_fee" value="{{$payroll->late_attendance_fee}}" readonly>
                        </div>
                        <div class="form-group">
                            <label for="performance_bonus" >Performance Bonus</label>
                            <input type="text" class="form-control" id="performance_bonus" name="performance_bonus" placeholder="5000/-" value="{{$payroll->performance_bonus}}">
                        </div>
                        <div class="form-group">
                            <label for="apprisal" >Apprisal</label>
                            <input type="text" class="form-control" id="apprisal" name="apprisal" placeholder="5000/-" value="{{$payroll->apprisal}}">
                        </div>
                        <div class="form-group">
                            <label for="bonus" >Bonus</label>
                            <select class="form-control" name="bonus" id="bonus" >
                                <option selected disabled value="">Choose Department</option>
                                <option value="yes" @if(!empty($payroll->bonus)) selected @endif>Yes</option>
                                <option value="no" @if(empty($payroll->bonus)) selected @endif>No</option>
                            </select>
                        </div>
                        <div class="form-group" id="bonus_amount_field" style="display: none">
                            <label for="bonus_amount" >Bonus Amount</label>
                            <input type="text" class="form-control" id="bonus_amount" name="bonus_amount" value="{{$payroll->bonus}}" readonly>
                        </div>
                        <div class="form-group">
    ...
    <div class="row">
        <div class="col-md-3"></div>
        <div class="col-md-6">
            <button type="submit" class="btn btn-gradient-primary btn-lg btn-block" id="submit"><i class="mdi mdi-pencil"></i> Submit </button>
        </div>
    </div>
    {!! Form::close() !!}
    <script>
